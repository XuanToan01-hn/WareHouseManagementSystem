<%--
    Document   : purchase-create
    Refactored to match WMS template structure
--%>
...
<head>
    ...
    <style>
        /* Custom style cho bảng nhập liệu */
        .table-input input {
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="/pocontroller" method="POST" id="poForm">
                                ...
                                <div class="text-right mt-4">
                                    <a href="/polist" class="btn btn-secondary mr-2">Cancel</a>
...
<script>
    // Hàm tính toán thành tiền cho một dòng
    ...
    function addRow() {
        ...
        var newRow = firstRow.cloneNode(true); // Clone dòng đầu tiên
